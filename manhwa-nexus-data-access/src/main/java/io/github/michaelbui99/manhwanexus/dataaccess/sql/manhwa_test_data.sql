...
INSERT INTO manhwa (title, synopsis, chapter_count, volume_count, season_count, start_date, end_date, is_adult,
                    source_material, country_of_origin_id)
VALUES ('Solo Leveling',
        ...
        179, -1, 2, '2018-03-04', null, false, 'LIGHT_NOVEL', (SELECT id from country_code where code = 'KR'));
...
VALUES ('BASTARD',
        ...
        (SELECT id from country_code where code = 'KR'));
INSERT INTO manhwa_genre(manhwa_id, genre_id)
